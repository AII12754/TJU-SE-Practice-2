...
const mobileMerchantRoutes: RouteRecordRaw = {
    ...
    children: [
      ...
      { path: 'user-profile', name: 'MobileMerchantUserProfile', component: () => import('../views/mobile/customer/Profile/UserProfile.vue'), meta: { title: '我的资料' } }
    ]
};
...
const mobileAdminRoutes: RouteRecordRaw = {
    ...
    children: [
      ...
      { path: 'user-profile', name: 'MobileAdminProfile', component: () => import('../views/mobile/customer/Profile/UserProfile.vue'), meta: { title: '我的资料' } }
    ]
};
...
routes.push({
  ...
  name: 'MobileEditUserProfile',
  component: () => import('../views/mobile/common/EditUserProfile.vue'),
  meta: { title: '编辑资料', requiresAuth: true, roles: ['CUSTOMER', 'MERCHANT', 'ADMIN'] },
});
